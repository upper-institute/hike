...
func main() {
	...
	// frontProxyCfg := &service_discovery.ServiceDiscovery_AddIngressInput{
	// 	XdsClusterName: "xds-cluster",
	// 	ListenPort:     8081,
	// 	ListenAddress:  "0.0.0.0",
	// 	EnableCors:     true,
	// 	HealthCheck: &service_discovery.ServiceDiscovery_HealthCheck{
	// 		Path: "/healthz",
	// 	},
	// 	IngressType: service_discovery.ServiceDiscovery_INGRESS_TYPE_WEB_SECURE_TRAFFIC,
	// 	GrpcWeb: &service_discovery.ServiceDiscovery_GrpcWeb{
	// 		Enabled: true,
